...
import type { Transaction as SolTransaction, TransactionSignature } from '@solana/web3.js';
...
import type { NearRawProvider, NearTransactionResponse, NearTxRequestBody } from './near';
import type { ProviderListeners, ProviderSubscriber } from './provider-event-bus';
import type { SolanaProvider } from './solana';
export type RawProvider = EthereumProvider | SolanaProvider | NearRawProvider | WalletConnectInitArgs;
...
export type TxRequestBody = Deferrable<TransactionRequest> | SolTransaction | NearTxRequestBody | string;
...
export type TransactionResponse = EthTransactionResponse | SolanaTransactionResponse | NearTransactionResponse;
