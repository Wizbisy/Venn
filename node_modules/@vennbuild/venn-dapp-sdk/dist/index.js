...
// index.ts
var venn_dapp_sdk_exports = {};
__export(venn_dapp_sdk_exports, {
  VennClient: () => VennClient,
  errors: () => errors
});
module.exports = __toCommonJS(venn_dapp_sdk_exports);
...
__export(api_errors_exports, {
  ...
  CanceledError: () => import_axios.CanceledError,
...
var import_w3p = require("@distributedlab/w3p");
...
var parseServerError = (error) => {
  var _a;
  if (!(0, import_axios2.isAxiosError)(error)) return error;
...
var parseApiError = (error) => {
  if (!(0, import_axios2.isAxiosError)(error)) return null;
  switch (error.code) {
...
var isValidEthereumAddress = (address) => (0, import_ethers.isAddress)(address);

// src/venn-client/index.ts
var supportedProviders = {
  [import_w3p.PROVIDERS.Metamask]: import_w3p.MetamaskProvider,
  [import_w3p.PROVIDERS.Coinbase]: import_w3p.CoinbaseProvider
};
var VennClient = class {
  ...
  constructor(opts) {
    ...
    this.apiInstance = import_axios3.default.create({ baseURL: this.url });
  }
  initProvider() {
    return __async(this, null, function* () {
      if (typeof window === "undefined") return;
      try {
        const providerDetector = new import_w3p.ProviderDetector();
        yield providerDetector.init();
        const availableProviders = Object.keys(providerDetector.providers);
        if (!availableProviders.length) throw new import_w3p.errors.ProviderInjectedInstanceNotFoundError();
        const providerProxyConstructor = supportedProviders[availableProviders[0]];
        this.web3Provider = yield (0, import_w3p.createProvider)(providerProxyConstructor, { providerDetector });
      } catch (error) {
        console.warn(
